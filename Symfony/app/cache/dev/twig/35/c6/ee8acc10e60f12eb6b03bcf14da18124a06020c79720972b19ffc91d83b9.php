...
class __TwigTemplate_35c6ee8acc10e60f12eb6b03bcf14da18124a06020c79720972b19ffc91d83b9 extends Twig_Template
{
    ...
    <section class=\"col-md-9 main_content\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recipes"]) {
            ...
            echo "</td>
                        <td>";
            // line 88
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getContext($context, "recipes"), "postedOn"), "Y-m-d H:i:s"), "html", null, true);
            echo "</td>
                        <td>
                            <button class=\"btn btn-large btn-primary\" type=\"submit\" formaction=\"";
            // line 90
            echo $this->env->getExtension('routing')->getPath("Recipe_editrecipe");
            echo "\">Edit</button>
